            ...
            <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr] gap-0 items-center justify-items-stretch pt-20 w-full">
              ...
              <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr] items-center w-full">
                <form className="font-montserrat flex items-center mx-auto w-full px-20">   
                    ...
                    <button type="submit" className="p-5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
