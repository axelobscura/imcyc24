              ...
              <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr] items-center w-full">
                <form className="font-montserrat flex items-center mx-auto w-full px-20">   
                    ...
                    <div className="relative w-full">
                        ...
                        <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-12 p-5.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 p-4" placeholder="Ingrese su consulta..." required />
                    </div>
