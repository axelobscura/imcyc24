...
export default function ProveedorDeEnsayosDeAptitud() {
  return (
    <div>
      <div className="flex items-center justify-items-center min-h-screen p-0 gap-16 sm:p-0 font-[family-name:var(--font-geist-sans)] bg-[url('/aptitud.jpg')] bg-gray-300 bg-blend-multiply z-10 bg-cover bg-center bg-no-repeat">
