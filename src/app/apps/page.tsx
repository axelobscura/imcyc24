...
export default function Apps() {
  ...
  return (
    <div>
      <div className="grid grid-rows-[20px_1fr_20px] p-8 pb-20 gap-16 sm:p-20 min-h-screen font-[family-name:var(--font-geist-sans)] bg-[url('https://www.webinarsenconcreto.com/images/2022/fondo1.jpg')] bg-gray-700 bg-blend-multiply z-10 bg-cover bg-center bg-no-repeat">
        <div className="mx-auto w-full max-w-screen-xl p-4 mt-10 sm:pt-120 pb-0 lg:py-90">
          <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start z-0 w-full">
            <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr] gap-0 items-center justify-items-stretch pt-20 w-full">
              ...
              <div className="grid grid-cols-[1fr] md:grid-cols-[1fr_1fr_1fr] py-10 gap-5">
