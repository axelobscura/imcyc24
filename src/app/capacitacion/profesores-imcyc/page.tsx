...
export default function ProfesoresImcyc() {
  return (
    <div>
      <div className="grid grid-rows-[1fr] p-0 gap-16 sm:py-20 font-[family-name:var(--font-geist-sans)] bg-gray-900 bg-blend-multiply z-10 bg-cover bg-center bg-no-repeat">
        <main className="grid grid-cols-[1fr] sm:grid-cols-[1fr] gap-0 z-0 px-36 max-w-screen-xl items-start text-white">
