            ...
            <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr] gap-0 items-center justify-items-stretch pt-20 w-full">
              ...
              <div className="grid grid-cols-[1fr] sm:grid-cols-[1fr_2fr] gap-10">
                <div>
                  ...
                  <p className={`bg-opacity-70 ${useProducto === "apelaciones" ? 'bg-slate-100 bg-opacity-100 text-gray-900' : 'bg-slate-800'} font-montserrat bg-blend-multiply w-full p-5 sm:mb-5 hover:bg-slate-100 hover:text-gray-900 font-bold flex flex-row items-center justify-between text-gray-100 cursor-pointer`} onClick={() => setProducto("apelaciones")}>APELACIONES <FaArrowAltCircleRight className="mr-3" size={20} /></p>
                  <p className={`bg-opacity-70 ${useProducto === "sugerencias" ? 'bg-slate-100 bg-opacity-100 text-gray-900' : 'bg-slate-800'} font-montserrat bg-blend-multiply w-full p-5 sm:mb-5 hover:bg-slate-100 hover:text-gray-900 font-bold flex flex-row items-center justify-between text-gray-100 cursor-pointer`} onClick={() => setProducto("sugerencias")}>SUGERENCIAS <FaArrowAltCircleRight className="mr-3" size={20} /></p>
                </div>
                <div>
                  <div className='bg-slate-900 bg-opacity-80 p-5'>
                      <>
                        <p className="font-montserrat text-2xl font-bold pb-2 flex items-center text-gray-100 mb-5 uppercase">
                          {useProducto === "quejas" ? "quejas" : useProducto === "apelaciones" ? "apelaciones" : "sugerencias"}
                        </p>
