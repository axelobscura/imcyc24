      ...
      <nav className="bg-white border-gray-200 dark:bg-black xs:hidden hidden sm:hidden md:block lg:block">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pt-2 pb-2 pl-4 pr-4">
              <div className="flex items-center space-x-6 rtl:space-x-reverse">
                  ...
                  <a href="tel:5541251234" className="font-montserrat text-sm  text-gray-500 dark:text-gray-200 hover:underline flex flex-row">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-5 font-light border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
              ...
              <li>
                <button
                  ...
                  className="font-montserrat flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded md:w-auto hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700 text-sm"
                >
                  GERENCIA TÉCNICA{" "}
                  <svg
