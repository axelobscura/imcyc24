      ...
      <div className="w-full flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pt-2 pb-2 pl-4 pr-4 text-white menu-responsivo">
        ...
        <NavbarCollapse>
          ...
          <MegaMenuDropdown
            ...
            toggle={
              <div className="font-montserrat whitespace-nowrap py-2 text-white lg:bg-blue-700 rounded md:bg-transparent md:text-gray-100 md:p-0 md:dark:text-gray-100 text-sm uppercase flex items-center mr-0 pr-0">
                Gerencia Técnica
              </div>
            }
          >
