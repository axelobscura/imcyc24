...
export default function Historia() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] min-h-screen p-0 pb-20 gap-16 sm:p-10 sm:pt-32 font-[family-name:var(--font-geist-sans)] bg-gradient-to-b from-slate-800 to-slate-950 z-10 bg-cover bg-fixed bg-no-repeat">
