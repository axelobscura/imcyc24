        ...
        <div>
            <div className="grid grid-rows-[1fr] pb-20 gap-16 sm:p-20 bg-gray-900 bg-gradient-to-t from-gray-800 to-slate-900 font-[family-name:var(--font-geist-sans)] z-10 bg-cover bg-center bg-no-repeat py-40 sm:py-40">
                ...
                <div className="my-5 grid grid-cols-1 sm:grid-cols-[1fr_1fr_1fr_1fr] md:grid-cols-4 gap-6 text-white font-montserrat text-center mt-7">
                    <div className="bg-slate-900 border border-slate-500 p-3 py-5 rounded-[30px] flex flex-col justify-center items-center">
                        <BsCreditCard2FrontFill size={30} className="mb-3" />
                        <p className="font-bold">Tarjetas de Crédito</p>
                        <p>Visa, MasterCard, American Express</p>
                    </div>
                    <div className="bg-slate-900 border border-slate-500 p-3 rounded-[30px] flex flex-col justify-center items-center">
                ...
                <div className="bg-slate-900 p-5 rounded-[20px] mt-10">
                    <h2 className="font-montserrat text-4xl font-bold text-white pt-0 mb-0 pb-0">Información Importante</h2>
                    <p className="text-white">Lo que NO incluyen los planes</p>
                </div>
            </div>
            </div>
        </div>
