...
export default function Prensa() {
  ...
  return (
    <div>
      <div className="flex items-center justify-items-center p-0 gap-16 sm:p-0 font-[family-name:var(--font-geist-sans)] bg-[url('/libreria.png')] bg-gray-700 bg-blend-multiply bg-fixed z-10 bg-cover bg-center bg-no-repeat">
                    ...
                    >
                      <div key={index} className="font-montserrat grid grid-cols-[1fr] sm:grid-cols-[1fr_3fr] gap-4 bg-gray-950 hover:bg-slate-800 cursor-pointer bg-opacity-50 bg-blend-multiply p-2 items-center justify-center mb-2 border border-gray-700">
                        ...
                        <div>
                          ...
                          <p className='flex items-center justify-center text-2xl font-bold py-3 pr-7 text-left sm:text-justify text-white'>{post[0]}</p>
                        </div>
                      </div>
                    </Link>
                  ))}
